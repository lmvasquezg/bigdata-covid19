...
Para acceder a los datos utilice la ruta: bigdatacovid.s3.amazonaws.com/<Global|Colombia>/<nombre_archivo>.csv
...
- **Situación Colombia:** Se analizaron los datos para obtener información relevante sobre ellos tales como: Situación actual colombiana, distribución geográfica de los infectados y centros de contagio, estado y procedencia de los infectados actuales, casos por sexo y curva de casos confirmados, recuperados y muertos.

- **Situación Global:** Con los datos obtenidos a nivel mundial se lograron determinar los países con más y menos casos activos, recuperado y muertos, así como las curvas de crecimiento y cifras actuales de cada una de estas poblaciones en el tiempo.
